...
#        global unique_2letters
        ...
        for term in result:
#            if len(term) < 3:
#                unique_2letters[term] = 0
#            elif term[0:3] not in unique_2letters:
#                unique_2letters[term[0:3]] = 0
...
#                        print("Term Index: " + str(term_index))
...
#                            print("cur_term: " + str(cur_term) + " | " + str(index[cur_term]))
...
#    with open("unique_letters.p", "w") as oFile:
#        oFile.write(str(unique_2letters))
#    print("Length of unique: " + str(len(unique_2letters)))
